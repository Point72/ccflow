...
To work on `ccflow`, you are going to need to build it from source. See
[Build from Source](Build-from-Source) for
detailed build instructions.

Once you've built `ccflow` from a `git` clone, you will also need to
configure `git` and your GitHub account for `ccflow` development.

## Step 2: Configuring Git and GitHub for Development

### Create your fork

The first step is to create a personal fork of `ccflow`. To do so, click
the "fork" button at https://github.com/Point72/ccflow, or just navigate
[here](https://github.com/Point72/ccflow/fork) in your browser. Set the
